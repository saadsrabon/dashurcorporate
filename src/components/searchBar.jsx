  ...
  return (
    <div>
        <div className="flex  justify-center items-center w-[300px] md:w-[350px] lg:w-[443px] h-20 searchbar">
            <input className="bg-transparent z-10 placeholder:text-xl placeholder:font-sans placeholder:dark:text-dark-text placeholder:text-light-text" type="text" placeholder="Search a service" />
