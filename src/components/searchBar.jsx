...
const SearchBar = () => {
  return (
    <div>
        <div className="flex  justify-around items-center w-[300px] md:w-[350px] lg:w-[443px] h-20 searchbar">
            <input className="bg-transparent flex-grow-0 outline-none z-10 placeholder:text-xl placeholder:font-sans placeholder:dark:text-dark-text placeholder:text-light-text px-4 py-2" type="text" placeholder="Search a service" />
