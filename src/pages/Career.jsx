        ...
        jobData.map((job, index) => (
          <CardWrapper key={index}>
            ...
            <div className="flex flex-col md:flex-row justify-center md:space-x-6 mt-4">
              ...
              <button onClick={()=>setShowJob(prev=>!prev)} className="px-2 py-3 text-light-primary text-base font-medium rounded-lg bg-transparent border-light-primary border-2" >View Job Description</button>
            </div>
          </CardWrapper>
        ))
      }
