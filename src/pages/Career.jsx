  ...
  return (
    <div className="w-full md:w-4/5 lg:w-3/4 xl:w-2/3 mx-auto my-12 mt-48 flex-col items-center px-4">
      ...
      <div role="tablist" className="tabs tabs-lifted my-12">
        <a onClick={() => setTabIndex(0)} role="tab" className={`${tabIndex === 0 ? "tab tab-active font-bold  dark:text-dark-text" : "tab text-light-text dark:text-dark-text"}`}>
          Job Positions
        </a>
        <a onClick={() => setTabIndex(1)} role="tab" className={`${tabIndex === 1 ? "tab tab-active font-bol  dark:text-dark-text" : "tab text-light-text dark:text-dark-text"}`}>
          Learning Lab
        </a>
      </div>
      {tabIndex === 0 &&
