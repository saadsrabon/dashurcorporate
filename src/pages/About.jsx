  ...
  return (
    <div className="w-[80%] mx-auto my-12 lg:my-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <h2 className="text-light-text text-left py-4 text-[24px] md:text-5xl uppercase font-sans font-bold  dark:text-dark-text">Connecting Dreams, Crafting Realities</h2>
    </div>
